      ...
      <Card className="w-full max-w-md border-border/30 shadow-dark">
        <form onSubmit={handleSignup}>
          <CardHeader className="text-center">
            ...
            <CardDescription>Start managing your taxxes with confidence</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="first">First name</Label>
                <Input id="first" placeholder="John" value={first} onChange={(e) => setFirst(e.target.value)} required />
              </div>
              <div className="space-y-2">
