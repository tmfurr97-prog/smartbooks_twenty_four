...
export default function Dashboard() {
  ...
  return (
    <div>
      ...
      <p className="text-muted-foreground mb-8">Here's an overview of your tax preparation progress.</p>
      ...
      <a href="https://www.irs.gov/wheres-my-refund" target="_blank" rel="noopener noreferrer" className="block mb-10">
