import {
  Shield, Upload, MessageSquare, Bot, Video, FolderLock,
  Brain, ScanSearch, FileCheck, BellRing,
  ClipboardList, CalendarClock, BarChart3,
  Receipt, DollarSign, Tags, Stamp
} from "lucide-react";
...
const featureGroups = [
  {
    ...
    accent: true,
    features: [
      { icon: Brain, title: "Auto‑Sorting", description: "AI categorizes your uploads (W-2, 1099, receipt) automatically." },
      { icon: ScanSearch, title: "Auto‑Naming", description: "Smart file names so you never dig through 'IMG_4023' again." },
      { icon: FileCheck, title: "Duplicate Detection", description: "Instantly flags files you've already uploaded." },
      { icon: BellRing, title: "Missing Doc Alerts", description: "Know exactly which documents are still needed before filing." },
    ],
  },
  {
    heading: "AI Support",
  ...
  },
  {
    ...
    features: [
      { icon: Upload, title: "Secure Uploads", description: "Upload W-2s, 1099s, receipts, and IDs through our encrypted portal." },
      { icon: FolderLock, title: "Year‑Round Vault", description: "Store and organize your financial documents securely all year." },
      { icon: Shield, title: "Bank‑Level Security", description: "End‑to‑end encryption and AES‑256 storage keep your data safe." },
    ],
  },
];
